...
func (x *MessageData) Reset() {
	*x = MessageData{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pb_profile_proto_msgTypes[0]
...
func (*MessageData) Descriptor() ([]byte, []int) {
	return file_pb_profile_proto_rawDescGZIP(), []int{0}
}
...
func (x *ProfileRequest) Reset() {
	*x = ProfileRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pb_profile_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ProfileRequest) Descriptor() ([]byte, []int) {
	return file_pb_profile_proto_rawDescGZIP(), []int{1}
}
...
func (x *ProfileResponse) Reset() {
	*x = ProfileResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pb_profile_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ProfileResponse) Descriptor() ([]byte, []int) {
	return file_pb_profile_proto_rawDescGZIP(), []int{2}
}
...
var file_pb_profile_proto_rawDesc = []byte{
	0x0a, 0x10, 0x70, 0x62, 0x2f, 0x70, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x12, 0x03, 0x64, 0x74, 0x6f, 0x22, 0xc5, 0x01, 0x0a, 0x0b, 0x4d, 0x65, 0x73, 0x73,
	...
	0x5e, 0x0a, 0x0e, 0x50, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x12, 0x32, 0x0a, 0x0b, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x44, 0x61, 0x74, 0x61,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x64, 0x74, 0x6f, 0x2e, 0x4d, 0x65, 0x73,
	...
	0x75, 0x0a, 0x0f, 0x50, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x12, 0x32, 0x0a, 0x0b, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x44, 0x61, 0x74,
	0x61, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x64, 0x74, 0x6f, 0x2e, 0x4d, 0x65,
	...
	0x75, 0x6d, 0x6d, 0x61, 0x72, 0x79, 0x42, 0x08, 0x5a, 0x06, 0x2e, 0x2e, 0x2f, 0x64, 0x74, 0x6f,
	0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_pb_profile_proto_rawDescOnce sync.Once
	file_pb_profile_proto_rawDescData = file_pb_profile_proto_rawDesc
)

func file_pb_profile_proto_rawDescGZIP() []byte {
	file_pb_profile_proto_rawDescOnce.Do(func() {
		file_pb_profile_proto_rawDescData = protoimpl.X.CompressGZIP(file_pb_profile_proto_rawDescData)
	})
	return file_pb_profile_proto_rawDescData
}

var file_pb_profile_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_pb_profile_proto_goTypes = []interface{}{
	(*MessageData)(nil),     // 0: dto.MessageData
	(*ProfileRequest)(nil),  // 1: dto.ProfileRequest
	(*ProfileResponse)(nil), // 2: dto.ProfileResponse
}
var file_pb_profile_proto_depIdxs = []int32{
	0, // 0: dto.ProfileRequest.messageData:type_name -> dto.MessageData
	0, // 1: dto.ProfileResponse.messageData:type_name -> dto.MessageData
...
func init() { file_pb_profile_proto_init() }
func file_pb_profile_proto_init() {
	if File_pb_profile_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_pb_profile_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pb_profile_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pb_profile_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_pb_profile_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pb_profile_proto_goTypes,
		DependencyIndexes: file_pb_profile_proto_depIdxs,
		MessageInfos:      file_pb_profile_proto_msgTypes,
	}.Build()
	File_pb_profile_proto = out.File
	file_pb_profile_proto_rawDesc = nil
	file_pb_profile_proto_goTypes = nil
	file_pb_profile_proto_depIdxs = nil
}
